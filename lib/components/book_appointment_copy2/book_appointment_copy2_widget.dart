...
import 'book_appointment_copy2_model.dart';
...
class BookAppointmentCopy2Widget extends StatefulWidget {
  ...
  _BookAppointmentCopy2WidgetState createState() =>
      _BookAppointmentCopy2WidgetState();
}

class _BookAppointmentCopy2WidgetState extends State<BookAppointmentCopy2Widget>
    with TickerProviderStateMixin {
  late BookAppointmentCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookAppointmentCopy2Model());
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '7ctv9yg2' /* Fill out the information below... */,
                        ),
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    '7tykwqqv' /* Emails will be sent to: */,
                  ),
                  style: FlutterFlowTheme.of(context).bodyMedium,
                ),
              ),
              ...
              Padding(
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  options: [
                    FFLocalizations.of(context).getText(
                      'fy7f822r' /* Type of Appointment */,
                    ),
                    FFLocalizations.of(context).getText(
                      '6mra8bp2' /* Doctors Visit */,
                    ),
                    FFLocalizations.of(context).getText(
                      'cmht0vdz' /* Routine Checkup */,
                    ),
                    FFLocalizations.of(context).getText(
                      'hjtj34qu' /* Scan/Update */,
                    )
                  ],
                  onChanged: (val) =>
