...
import 'book_appointment_copy2_copy_model.dart';
...
class BookAppointmentCopy2CopyWidget extends StatefulWidget {
  ...
  _BookAppointmentCopy2CopyWidgetState createState() =>
      _BookAppointmentCopy2CopyWidgetState();
}

class _BookAppointmentCopy2CopyWidgetState
    extends State<BookAppointmentCopy2CopyWidget>
    with TickerProviderStateMixin {
  late BookAppointmentCopy2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookAppointmentCopy2CopyModel());
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'cgdt6tu9' /* Fill out the information below... */,
                        ),
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'dtixf9i3' /* Emails will be sent to: */,
                  ),
                  style: FlutterFlowTheme.of(context).bodyMedium,
                ),
              ),
              ...
              Padding(
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  options: [
                    FFLocalizations.of(context).getText(
                      'pq1uguxg' /* Type of Appointment */,
                    ),
                    FFLocalizations.of(context).getText(
                      'y8ypa0vm' /* Doctors Visit */,
                    ),
                    FFLocalizations.of(context).getText(
                      '8kg5o7gf' /* Routine Checkup */,
                    ),
                    FFLocalizations.of(context).getText(
                      'sfou5cvz' /* Scan/Update */,
                    )
                  ],
                  onChanged: (val) =>
