...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'numberemail',
          path: '/numberemail',
          builder: (context, params) => NumberemailWidget(),
        ),
        FFRoute(
          name: 'Newpassword',
          path: '/newpassword',
        ...
        FFRoute(
          name: 'GetDriver',
          path: '/getDriver',
          builder: (context, params) => GetDriverWidget(),
        ),
        FFRoute(
          name: 'Payment',
          path: '/payment',
        ...
        FFRoute(
          name: 'PaymentM',
          path: '/paymentM',
          builder: (context, params) => PaymentMWidget(),
        ),
        FFRoute(
          name: 'TopUp',
          path: '/topUp',
        ...
        FFRoute(
          name: 'PinC',
          path: '/pinC',
          builder: (context, params) => PinCWidget(),
        ),
        FFRoute(
          name: 'Fingerprint',
          path: '/fingerprint',
          builder: (context, params) => FingerprintWidget(),
        ),
        FFRoute(
          name: 'Faqs',
          path: '/faqs',
        ...
        FFRoute(
          name: 'SizePage',
          path: '/sizePage',
          builder: (context, params) => SizePageWidget(),
        ),
        FFRoute(
          name: 'Preview',
          path: '/preview',
        ...
        FFRoute(
          name: 'notificationsSettingsCopy',
          path: '/notificationsSettingsCopy',
          builder: (context, params) => NotificationsSettingsCopyWidget(),
        ),
        FFRoute(
          name: 'Invite',
          path: '/invite',
